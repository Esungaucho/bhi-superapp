...
export default function PostComposer() {
  ...
  const [category, setCategory] = useState('community_chat');
      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 space-y-3">
          <textarea
            ...
            placeholder={`What's happening on the island${firstName ? ', ' + firstName : ''}?`}
            rows={3}
            className="w-full bg-secondary/50 rounded-xl px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-accent resize-none"
          />
          ...
          {imageUrl && (
            <div className="relative rounded-xl overflow-hidden">
              ...
              <button onClick={() => setImageUrl(null)} className="absolute top-2 right-2 bg-black/60 rounded-full p-1 text-white">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-semibold bg-primary text-primary-foreground rounded-full px-4 py-2 disabled:opacity-40"
            >
