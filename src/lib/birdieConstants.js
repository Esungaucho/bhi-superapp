...
export const BIRDIE_CATEGORIES = [
  ...
  { id: 'beach_chairs', label: 'Beach Chairs', Icon: Sun, description: 'Chairs, umbrellas, shade' },
  ...
  { id: 'shoes', label: 'Shoes', Icon: Shirt, description: 'Footwear for any occasion' },
  { id: 'swimsuits', label: 'Swimsuits', Icon: Waves, description: 'Swimwear for everyone' },
  { id: 'holiday_items', label: 'Holiday Items', Icon: Gift, description: 'Seasonal and festive decor' },
  { id: 'easter_baskets', label: 'Easter Baskets', Icon: Gift, description: 'Pre-made and custom baskets' },
  { id: 'birthday_gifts', label: 'Birthday Gifts', Icon: PartyPopper, description: 'Gifts, cards, wrapping' },
  { id: 'decorations', label: 'Decorations', Icon: PartyPopper, description: 'Party and event decor' },
  ...
  { id: 'chargers', label: 'Chargers', Icon: Zap, description: 'Phone and device chargers' },
  ...
  { id: 'last_minute', label: 'Last-Minute Essentials', Icon: Zap, description: 'Forgot something? We have got you' },
];
